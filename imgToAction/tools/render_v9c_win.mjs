...
const vmdFiles = [{ name: "front_depth_v9c" }];
const outBase = path.join(projectRoot, "imgToAction", "outputs", "actions", "stages_3_6_v9c_render");
...
const FRONT_AXIS = [0, -0.140048, -0.990145];  // Fixed: points -Z (front)
