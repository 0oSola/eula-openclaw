...
export function createDiagnosticBlankBrowserWindowOptions(bounds) {
    return {
        ...bounds,
        show: true,
        transparent: false,
...
export function createContextMenuBrowserWindowOptions(preloadPath, bounds) {
    return {
        ...bounds,
        show: true,
        transparent: false,
...
export function resolveContextMenuWindowBounds({ point, workArea, }) {
